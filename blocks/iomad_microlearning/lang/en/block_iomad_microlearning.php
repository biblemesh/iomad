...
$string['bulkassigngroups'] = 'Assign thread groups by CSV';
...
$string['cmidalreadyinuse'] = 'Course module ID is already in use';
...
$string['deletegroupcheckfull'] = 'Do you want to delete group {$a}?  This will also remove any users associated to this group.';
...
$string['deletethreadcheckfull'] = 'Are you sure you want to completely delete thread {$a} and all associated nuggets and users';
$string['duedate'] = 'Due date';
$string['duedatebeforescheduledate'] = 'The due date is before the scheduled date';
$string['editgroup'] = 'Edit group';
$string['editnugget'] = 'Edit nugget';
$string['editthread'] = 'Edit thread';
$string['erroredgroups'] = 'Errored group assignments';
$string['group'] = 'Thread group';
$string['group_help'] = 'This is the group within the microlearning thread which the user will be assigned to';
$string['groupcreatedok'] = 'Group has been created successfully';
$string['groupdeletedok'] = 'Group has been deleted successfully';
$string['groupupdatedok'] = 'Group has been updated successfully';
$string['halt_until_fulfilled'] = 'Halt messages until completed';
$string['halt_until_fulfilled_help'] = 'Set this to true if you wish to halt sending any messages until the previous nugget is completed.';
$string['importgroupsfromfile'] = 'Import thread user group assignments';
$string['importthread'] = 'Import thread';
$string['importthreadcheckfull'] = 'Are you sure you want to import thread {$a} and all associated nuggets to a new thread in this company?  This does not copy over any currently assigned users.';
$string['importusergroups'] = 'Import thread user groups';
...
$string['ibnalidthreadid'] = 'The thread you are looking for does not exist.';
$string['iomad_microlearning:addinstance'] = 'Add a microlearning block';
$string['iomad_microlearning:assign_threads'] = 'Assign a user to a microlearning thread';
$string['iomad_microlearning:importgroupfromcsv'] = 'Assign thread groups to users via CSV';
$string['iomad_microlearning:manage_groups'] = 'Manage thread groups';
...
$string['iomad_microlearning:thread_view'] = 'View microlearning threads';
$string['iomad_microlearning:view'] = 'View IOMAD microlearning';
$string['learninggroups'] = 'Manage thread groups';
$string['learningnuggets'] = 'Manage nuggets';
$string['learningschedules'] = 'Manage schedules';
$string['learningusers'] = 'Manage thread users';
$string['message_preset'] = 'Send message after';
$string['message_preset_help'] = 'How long do we wait to send a message after';
$string['message_time'] = 'Send message time';
$string['message_time_help'] = 'What time of day are we sending this message.';
...
$string['startnextscheduled'] = 'Start next scheduled day';
$string['starttoday'] = 'Start today';
...
$string['threadname_help'] = 'The name of the microlearning thread';
$string['threads'] = 'Microlearning threads';
$string['threadschedule'] = 'Thread schedule';
$string['threadscheduleresetok'] = 'Thread schedule reset OK';
$string['threadscheduleupdatedok'] = 'Thread schedule updated OK';
$string['threadscheduleupdated'] = 'Microlearning thread schedule updated';
$string['threadupdated'] = 'Microlearning thread updated';
$string['threadupdatedok'] = 'Thread updated OK';
$string['timecreated'] = 'Time created';
$string['updown'] = 'Up/Down';
$string['uploadgroupresult'] = 'Upload groups result';
