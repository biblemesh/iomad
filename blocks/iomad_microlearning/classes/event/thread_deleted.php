...
class thread_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('threaddeleted', 'block_iomad_microlearning');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the microlearning thread with id '$this->objectid'";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->objectid, 'iomad', 'microlearning thread deleted ', '/blocks/iomad_microlearning/threads.php',
