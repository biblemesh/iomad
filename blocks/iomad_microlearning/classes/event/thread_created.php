...
/**
 * The block_iomad_microlearning thread created event.
 *
...
class thread_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('threadcreated', 'block_iomad_microlearning');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->objectid, 'iomad', 'microlearning thread created ', '/blocks/iomad_microlearning/threads.php',
