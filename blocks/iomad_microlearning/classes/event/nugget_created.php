...
/**
 * The block_iomad_microlearning nugget created event.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class nugget_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('nuggetcreated', 'block_iomad_microlearning');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->objectid, 'iomad', 'microlearning nugget created ', '/blocks/iomad_microlearning/nuggets.php',
