...
class user_assigned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' assigned the user with id '$this->relateduserid' from the microlearning thread with id '$this->objectid'";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->objectid, 'iomad', 'microlearning thread user assigned ', '/blocks/iomad_microlearning/users.php',
