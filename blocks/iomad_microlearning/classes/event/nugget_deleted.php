...
/**
 * The block_iomad_microlearning nugget deleted event.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class nugget_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('nuggetdeleted', 'block_iomad_microlearning');
    }
