...
/**
 * The block_iomad_microlearning thread deleted event.
 *
...
/**
 * The block_iomad_microlearning thread schedule updated event.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class thread_schedule_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('threadscheduleupdated', 'block_iomad_microlearning');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the schedule for the microlearning thread with id '$this->objectid'";
    }
